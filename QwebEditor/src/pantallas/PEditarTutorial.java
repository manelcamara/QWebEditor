...
/**
 * The Class PEditarTutorial: pantalla d'edició de tutorials
 */
public class PEditarTutorial extends javax.swing.JDialog{
    ...
    /**
     * Instantiates a new p editar tutorial.
     *
     * @param parent the parent
     * @param cuestionario the cuestionario
     * @param idioma the idioma
     */
    public PEditarTutorial(JFrame parent, Cuestionario cuestionario, String idioma) {
    	this.parent = parent;
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("PEditarTutorial")); // NOI18N
        setLocation(300,200);
        setResizable(false);
        ...
        jLabel2.setText(bundle.getString("Pantallas"));
        ...
        jButton5.setText(bundle.getString("NuevaPantalla"));
        jButton6.setText(bundle.getString("EditarPantalla"));
        jButton7.setText(bundle.getString("GuardarTutorial"));
    ...
    private class ListenerBotones implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			if (evt.getSource()==jButton5) {
				//nueva pantalla
				dispose();
				new PEditarPantalla(parent, cuestionario, idioma);
				...
				if (cuestionario.validarCuestionario()) {
					...
					new PMensaje(esteDialog, bundle.getString("TutorialNoValido"), idioma);
				}
			} else if (evt.getSource()==jButton6){
				//editar pantalla
				if (cuestionario.getNumeroDePreguntas()==0){
					new PMensaje(esteDialog, bundle.getString("TutorialSinPantallas"), idioma);
				} else {
					dispose();
					new PEditarPantalla(parent, cuestionario, idioma, jComboBox1.getSelectedIndex());
				}
